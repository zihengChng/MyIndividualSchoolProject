<div id="new-arrive-carousel" class="carousel slide widget widget-new-products product-carousel" data-interval="false">
	<div class="widget-title">
		<h2>New Arrives</h2>
		<a href="showAllBook.php" class="more-link">More</a>
		...
		<div class="carousel-inner" rol="listbox">
			...
			?>
					<div class="col-sm-3 col-xs-6">
						<a href="viewBookDetail.php?q=<?php echo $row['book_isbn']; ?>" class="product-image"><img src="../img/books/<?php echo $row['book_isbn'];?>.jpg" height="150" width="150"></a>
						<div class="product-info">
							<h2 class="product-name"><a href="viewBookDetail.php?q=<?php echo $row['book_isbn']; ?>"><?php echo $row['book_name']; ?></a></h2>
